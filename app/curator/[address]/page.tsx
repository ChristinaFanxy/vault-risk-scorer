  ...
  return (
    <div className="min-h-screen bg-brand-bg text-brand-cream p-6 max-w-4xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <h1 className="text-2xl font-bold text-brand-cream">Curator Bad Debt History</h1>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-8">
        <div className="bg-brand-card border border-brand-border rounded-lg p-4">
          <p className="text-xs text-brand-light">Realized Bad Debt</p>
        ...
        <div className="bg-brand-card border border-brand-border rounded-lg p-4">
          <p className="text-xs text-brand-light">Unrealized Bad Debt</p>
          ...
          <p className="text-xs text-brand-light/60 mt-0.5">Stuck borrows detected on-chain</p>
        </div>
        <div className="bg-brand-card border border-brand-border rounded-lg p-4">
          <p className="text-xs text-brand-light">Historical Vaults</p>
      ...
      {events.length === 0 && unrealizedBadDebtUsd === 0 ? (
        <div className="bg-brand-card border border-brand-border rounded-lg p-8 text-center">
          <p className="text-brand-olive text-lg font-medium">Clean record</p>
          <p className="text-brand-light text-sm mt-1">No bad debt events found across any chain</p>
        </div>
      ) : events.length === 0 ? null : (
        <div className="bg-brand-card border border-brand-border rounded-lg overflow-hidden">
          <div className="px-4 py-3 border-b border-brand-border">
            <h2 className="text-sm font-medium text-brand-cream">Bad Debt Events</h2>
